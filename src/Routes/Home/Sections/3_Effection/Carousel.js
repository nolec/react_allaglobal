...
const Carousel = props => {
  ...
  console.log(img_width, img_height, visibleImages);
  ...
  const parentWidth = img_width * 2; // To have thrice the width of an individual image
  ...
  const constructVisibleItemsProps = () => {
    ...
    while (timesToIterate < visibleImages) {
      ...
      console.log(timesToIterate, elementsInRight, "뭐냐");
